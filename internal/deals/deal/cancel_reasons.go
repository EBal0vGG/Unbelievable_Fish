...
const (
	...
	// DealCancelReasonBuyerInitiatedCancel — покупатель отменил сделку (в т.ч. по соглашению) до оплаты; депозит удерживается как при WinnerRejected.
	DealCancelReasonBuyerInitiatedCancel = "BUYER_INITIATED_CANCEL"
)
